...
$csvFile = __DIR__ . '/forces_questions.csv';
$questions = [];
...
<head>
    ...
    <script>
       ...
       function showResults() {
            ...
            let levelLink = "";
            if (correctAnswers < 4) {
                levelMessage = `Oh oh! You have scored really less!<br><br>This means you only have really little knowledge in this area. Let's go to Basics Level 1 and learn more!`;
                levelLink = '<a href="basic1.php?topic=Forces" class="level-btn">Go to Basics Level 1 Learning</a>';
            } else if (correctAnswers < 8) {
                levelMessage = `Hmm, you have scored below 6!<br><br>This means you only have little knowledge in this area. Let's go to Basics Level 2 and learn more!`;
                ...
                levelMessage = `Congratulations! You have scored high!<br><br>This means you have good level of knowledge in this area already! Let's go to Intermediate Level and learn more!!!`;
                levelLink = '<a href="intermediate.php?topic=Forces" class="level-btn">Go to Intermediate Level Learning</a>';
            } */
