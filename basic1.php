...
<section class = "sub-header">
    ...
    <h1 style="font-size: 40px; font-weight: 500;">Basics Level 1 : <?php echo htmlspecialchars($topic); ?></h1>
...
<section class = "course">
    <h3 style="text-align: left; color:white;"> This is the Basics level 1 of learning of this topic. Here you can find materials, that you can do revision with.<br>After revising click on the button below to go to the next level!</h3>
    ...
    <div class="row">
        <div class="course-col">
            ...
            <h3>Click the button below to proceed to the next level.<br>You will be evaluated again and can only proceed to the next level if your score is above 6.</h3>
