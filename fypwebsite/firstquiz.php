...
<head>
    ...
    <script>
        const questions = [
            ...
            { question: "What type of force causes objects to fall towards the Earth?", answers: ["Magnetic", "Friction", "Gravity", "Electric"], correct: 2 }, 
            { question: "What happens to an object's motion if the forces acting on it are balanced?", answers: ["It speeds up", "It changes direction", "It moves in circles", "It stays at rest or moves at a constant speed"], correct: 3 }, 
            { question: "Which force slows down a car as it moves along a road?", answers: ["Magnetic force", "Gravitational force", "Air resistance", "Nuclear force"], correct: 2 }, 
            { question: "What is the term for the force that pushes back when you push against a wall?", answers: ["Gravitational force", "Reaction force", "Magnetic force", "Electric force"], correct: 1 }, 
            { question: "Which of the following objects experiences the least friction when moving?", answers: ["A car tire on gravel", "A sled on ice", "A shoe on concrete", "A bicycle on grass"], correct: 1 }
        ...
        function showResults() {
            ...
            let levelLink = "";
            if (correctAnswers <= 4) {
                levelMessage = `Oh oh! You have scored below 5!<br><br>This means you only have little knowledge in this area. Let's go to Basics Level and learn more!`;
                levelLink = '<a href="basic.php?topic=Forces" class="level-btn">Go to Basics Level Learning</a>';
            } else if (correctAnswers <= 9) {
                levelMessage = `Great! You have scored well!<br><br>This means you have basics level of knowledge in this area. Let's go to Intermediate Level and learn more!`;
                levelLink = '<a href="intermediate.php?topic=Forces" class="level-btn">Go to Intermediate Level Learning</a>';
            } else {
                levelMessage = `Congratulations! You have scored high!<br><br>This means you have good level of knowledge in this area already! Let's go to Expert Level and learn more!!!`;
                levelLink = '<a href="expert.php?topic=Forces" class="level-btn">Go to Expert Level Learning</a>';
            }
...
<body>
    <h1>Quiz about <?php echo $topic; ?></h1>
