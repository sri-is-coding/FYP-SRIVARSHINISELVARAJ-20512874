...
<section class = "sub-header">
    ...
    <h1 style="font-size: 40px; font-weight: 500;">Basics Level : <?php echo htmlspecialchars($topic); ?></h1>
...
<section class = "course">
    <h3 style="text-align: left; color:white;"> This is the Basics level of learning of this topic. Here you can find materials, that you can do revision with.<br>After revising click on the button below to go to the next level!</h3>

    <div class="row">
        <div class="course-col">
            <h3>Click the button below to learn more about your topic.</h3>
            <a href="study.php?topic=<?php echo urlencode($topic); ?>" class="study-btn"> Study the topic now! </a><br><br>
            <h3>Click the button below to proceed to the Intermediate level.<br>You will be evaluated again and can only proceed to Intermediate level if your score is above 4.</h3>
            <a href="firstquiz.php?topic=<?php echo urlencode($topic); ?>" class="study-btn"> Proceed </a>
        </div>
    </div>
