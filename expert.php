...
<section class = "course">
    <h2 style="text-align: center; color:white;">You have become an Expert in this topic !!!</h2><br>
    <p>You can now proceed to study other topics.</p>

    <div class="row">
        <div class="course-col1">
            <h3>Click the button below to go back to home to learn a new topic.</h3>
            <a href="mainpage.php?topic=<?php echo urlencode($topic); ?>" class="go-btn"> Go Back to Home </a>
        </div>
    </div>
