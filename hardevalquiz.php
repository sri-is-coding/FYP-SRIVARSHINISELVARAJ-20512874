...
<head>
    ...
    <script>
       ...
       function showResults() {
            ...
            let levelLink = "";
            if (correctAnswers < 5) {
                levelMessage = `Oh oh! You have scored less!<br><br>This means you have to revise once again. Let's go back to Basics Level 2 and learn again!`;
                levelLink = '<a href="basic2.php?topic=Forces" class="level-btn">Go to Basics Level 2 Learning</a>';
            } else if (correctAnswers < 8) {
                levelMessage = `Oh oh! You have scored below 8!<br><br>This means you have to revise once again. Let's go back to Intermediate Level again and learn more!`;
                levelLink = '<a href="intermediate.php?topic=Forces" class="level-btn">Go to Intermediate Level Learning</a>';
            } else {
                levelMessage = `Great! You have scored well!<br><br>This means you have gained great knowledge in this area. Let's go to Expert Level!`;
                levelLink = '<a href="expert.php?topic=Forces" class="level-btn">Go to Expert Level</a>';
            }
